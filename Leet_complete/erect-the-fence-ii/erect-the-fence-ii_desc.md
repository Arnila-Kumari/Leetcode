Can you solve this real interview question? Erect the Fence II - You are given a 2D integer array trees where trees[i] = [xi, yi] represents the location of the ith tree in the garden.
