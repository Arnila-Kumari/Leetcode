Can you solve this real interview question? Minimum Number of Lines to Cover Points - You are given an array points where points[i] = [xi, yi] represents a point on an X-Y plane.
