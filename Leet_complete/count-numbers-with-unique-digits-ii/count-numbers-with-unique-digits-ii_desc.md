Can you solve this real interview question? Count Numbers With Unique Digits II - Given two positive integers a and b, return the count of numbers having unique digits in the range [a, b] (inclusive).
