Can you solve this real interview question? Maximize Count of Distinct Primes After Split - You are given an integer array nums having length n and a 2D integer array queries where queries[i] = [idx, val].
