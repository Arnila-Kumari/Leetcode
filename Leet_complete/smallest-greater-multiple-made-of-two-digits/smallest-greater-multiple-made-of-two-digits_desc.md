Can you solve this real interview question? Smallest Greater Multiple Made of Two Digits - Given three integers, k, digit1, and digit2, you want to find the smallest integer that is:
