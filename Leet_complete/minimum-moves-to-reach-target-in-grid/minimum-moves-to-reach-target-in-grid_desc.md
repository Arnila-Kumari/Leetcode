Can you solve this real interview question? Minimum Moves to Reach Target in Grid - You are given four integers sx, sy, tx, and ty, representing two points (sx, sy) and (tx, ty) on an infinitely large 2D grid.
