Can you solve this real interview question? Minimum Cost Path with Alternating Directions II - You are given two integers m and n representing the number of rows and columns of a grid, respectively.
