Can you solve this real interview question? Maximum Increasing Triplet Value - Given an array nums, return the maximum value of a triplet (i, j, k) such that i < j < k and nums[i] < nums[j] < nums[k].
