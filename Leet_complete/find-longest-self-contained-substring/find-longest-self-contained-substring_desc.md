Can you solve this real interview question? Find Longest Self-Contained Substring - Given a string s, your task is to find the length of the longest self-contained substring of s.
