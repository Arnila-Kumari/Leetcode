Can you solve this real interview question? Number of Substrings With Fixed Ratio - You are given a binary string s, and two integers num1 and num2. num1 and num2 are coprime numbers.
